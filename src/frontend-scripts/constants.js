...
export const getBadWord = text => {
	...
	const exceptions = [/(i|o)f (a|4) g/gi, /big ga/gi, /underclaim on gov/gi, /big ga(e|m|y)/gi, /among/gi, /mongodb/gi, /mongolia/gi]; // This list for all exceptions to bypass swear filter
